---
description: MOJ governance rules for using AI tooling when generating code.
---

# AI Tooling and Governance

- Use only MOJ-approved AI tools (e.g. GitHub Copilot for engineers; follow the current approved list).
