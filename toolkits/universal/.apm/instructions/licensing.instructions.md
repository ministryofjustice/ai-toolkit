---
description: MOJ licensing and copyright requirements for software and code.
---

# Licensing

- MOJ uses the MIT License. Each repo must include a `LICENCE` or `LICENCE.md` containing the full licence text.
