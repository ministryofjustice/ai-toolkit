---
description: Accessibility standards (WCAG 2.2 AA) for public sector services.
applyTo: "**/*.{html,tsx,jsx,vue,css}"
---

# Accessibility (WCAG AA)

- Meet WCAG 2.2 Level AA (a legal requirement for the public sector).
